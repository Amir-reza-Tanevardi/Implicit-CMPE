...
if __name__=='__main__':
    ...
    train_ds = load_cifar(args.img_size, 'train')
    val_ds   = load_cifar(args.img_size, 'test')
    
    train_ds_unbatched = train_ds#.take()
    train_imgs = []
    train_lbls = []
    ...
    forward_train = {'prior_draws': train_imgs[:args.num_training],
    ...
    checkpoint_path = os.path.join(
        "checkpoints",
        f"cifar10-deblurring-cmpe-unet-49000-25-07-22-074548",
    )
