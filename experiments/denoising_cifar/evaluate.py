...
for key, trainer in trainer_dict.items():
    ...
    for theta in np.linspace(3,3,1):
        ...
        for i in range(n_datasets):
            ...
            for j in range(n_samples):
                recon_img = render_from_params(post_samples[i, j], img_size)  # <<< EDITED
